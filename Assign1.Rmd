...
for(i in 1:dim(mymat)[1])  
{
	...
	split=0.80
bound <- floor(nrow(df)*0.8)         #define % of training and test set

df <- df[sample(nrow(df)), ]           #sample rows 
data_train <- df[1:bound, ]              #get training set
...
#### printing the accuracy table ,precision table , recall table an f-score table
